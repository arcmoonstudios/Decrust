...
use decrust_core::{Autocorrection, DecrustError, ErrorCategory, FixType};
...
mod tests {
    ...
    use decrust_core::{ErrorContext, ErrorReportFormat, ErrorSeverity, ErrorSource, FixDetails};
